...
class GAScheduler:
    ...
    def fitness(self, population_size, parent_list, offspring_list):
        ...
        sorted_jobs = np.argsort(self.pt[:, 0]).tolist()
        ...
        for m in range(population_size * 2):
            ...
            # NOTE Evaluate chromosome based on adherence to SPT order
            spt_score = sum(
                [
                    1
            ...
            chrom_fitness.append(1 / makespan + spt_score)  # reciprocal of makespan
